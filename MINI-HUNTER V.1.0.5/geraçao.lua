...
function g_monster(dt, vetor_monster,t, window_w, window_h,round)
    ...
    local monster = {}
    monster.tipo = 4 --love.math.random(1,4)
    ...
    elseif monster.tipo == 4 then
        ...
        until  distanciaDoisPontos(monster.x,monster.y,player.x,player.y,400) == false
    ...
    for i=1 , #vetor_monster, 1 do
        ...
        if testmode then
            if monster.tipo ~= 4 then
                ...
                love.graphics.print(monster.xAleatorio.." "..monster.yAleatorio,0,250)
            end
        end
    end    
end
