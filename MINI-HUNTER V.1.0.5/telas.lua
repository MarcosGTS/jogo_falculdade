...
function telaInicialUpdate()
    ...
    if  mousex > window_w/2 - 100 and mousex < window_w/2 + 100 and mousey > window_h/2 +75 and mousey < window_h/2 + 125 and love.mouse.isDown(1) then
        return 3
    end
    return 0
end
...
function backGroundMusic()
    ...
    if podeSummonar == true or #monsters > 0 then
        audio.batalha:play()
    else
        audio.batalha:stop()
    end
